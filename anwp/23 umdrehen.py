...
while True:
    datenfrage = input("Möchtest du Daten eingeben Yes or No:")
    ...
    if datenfrage.lower() in fragelisteyes:
        ...
        print("\n\n")
        print(f"Vorm Umdrehen: {new}. Nach dem Umdrehen: {turn(new)}")
        print("\n\n")
...
print(f"Vorm Umdrehen: {string1}. Nach dem Umdrehen: {turn(string1)}\n")
int1 = -24
print(f"Vorm Umdrehen: {int1}. Nach dem Umdrehen: {turn(int1)}\n")
float1 = 24.77
print(f"Vorm Umdrehen: {float1}. Nach dem Umdrehen: {turn(float1)}\n")
list1 = [1, 2, 3, 4]
print(f"Vorm Umdrehen: {list1}. Nach dem Umdrehen: {turn(list1)}\n")
tuple1 = (1, 2, 3, 4)
print(f"Vorm Umdrehen: {tuple1}. Nach dem Umdrehen: {turn(tuple1)}\n")
